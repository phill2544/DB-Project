<?php
    ...
    $sql = "SELECT * FROM user WHERE U_state = 'user'";
...
<body>
    ...
    <!-- ค้นหา -->
    <div class="container" style="float: right; max-width:85%;">
        <form action="backend_search_user.php" method="GET">
            <div class="input-group mb-1">
                <input type="text" class="form-control" placeholder="กรอกชื่อผู้ใช้งาน" name="username">
